                    ...
                    child: Column(
                      ...
                      children: [
                        _PreviewSectionLabel(
                          ...
                          text: AppLocaleText.tr(
                            context,
                            en: 'Next week’s small experiment',
                            zhHans: '下周小实验',
                            zhHant: '下週小實驗',
                            ja: '来週の小さな実験',
                          ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    AppLocaleText.tr(
                      context,
                      en: 'Happened · Helpful · Adjust · Not right today',
                      zhHans: '发生了 · 有帮助 · 想调整 · 今天不适合',
                      zhHant: '發生了 · 有幫助 · 想調整 · 今天不適合',
                      ja: 'できた · 役立った · 調整 · 今日は合わない',
                    ),
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis,
                    style: const TextStyle(
